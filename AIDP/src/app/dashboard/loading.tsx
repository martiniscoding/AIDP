  ...
  return (
    <main className="mx-auto flex min-h-svh max-w-xl flex-col justify-center gap-4 px-6">
      <div aria-hidden="true" className="animate-pulse">
        <div className="h-7 w-40 rounded-full bg-white/[0.07]" />
        <div className="mt-4 h-4 w-64 rounded-full bg-white/[0.05]" />
        <div className="mt-3 h-4 w-80 max-w-full rounded-full bg-white/[0.04]" />
      </div>
