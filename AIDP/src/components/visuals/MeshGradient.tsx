...
export function MeshGradient({
  ...
  return (
    ...
    >
      {/* Cursor-anchored core glow: one purple wash, one neutral white
          highlight sitting inside it. No second hue. */}
      <div
        className="absolute inset-0"
        style={{
          background:
            "radial-gradient(46rem 40rem at var(--mx) var(--my), rgba(124,58,237,0.42), rgba(124,58,237,0) 64%)",
        }}
      />
      <div
        className="absolute inset-0"
        style={{
          background:
            "radial-gradient(20rem 18rem at var(--mx) var(--my), rgba(167,139,250,0.3), rgba(167,139,250,0) 62%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(109,40,217,0.4), rgba(109,40,217,0) 68%)",
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(255,255,255,0.16), rgba(255,255,255,0) 66%)",
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(124,58,237,0.32), rgba(124,58,237,0) 70%)",
